"""
The respective article could be found here : https://python.plainenglish.io/decision-tree-explained-a-step-by-step-guide-with-python-426ce6a25ab2
and the source code in the gitHub here : https://github.com/Marcussena/ML-and-Ai-from-scratch
"""
import numpy as np
